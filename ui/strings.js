...
const DICT = {
  pl: {
    ...
    'refuse.brak-openssl': 'nie ma czym wystawić certyfikatu (brak openssl — typowe na Windowsie)',
    'refuse.brak-certyfikatu': 'brak certyfikatu TLS',
    'refuse.whatToDo': 'Program został na 127.0.0.1. Zdalnie: tunel SSH. Albo podaj własny certyfikat w api.tls.certFile i api.tls.keyFile, albo zainstaluj openssl (na Windowsie jest w Git for Windows).',
  ...
  en: {
    ...
    'refuse.brak-openssl': 'nothing to issue a certificate with (no openssl — typical on Windows)',
    'refuse.brak-certyfikatu': 'no TLS certificate',
    'refuse.whatToDo': 'The program stayed on 127.0.0.1. Remotely: an SSH tunnel. Or provide your own certificate in api.tls.certFile and api.tls.keyFile, or install openssl (on Windows it ships with Git for Windows).',
